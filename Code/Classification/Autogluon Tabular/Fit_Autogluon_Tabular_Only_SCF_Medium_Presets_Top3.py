...
train_df = combine_directory_parquets('../../../Data/Features/Top3_Features/train')
...
os.makedirs('../../../Output/Classifier Fitting/Autogluon/Autogluon_Tabular_Only_SCF_Medium_Presets_Top3', exist_ok=True)
...
np.random.seed(222)
# Run predictor
predictor = TabularPredictor(label='Class', path='../../../Output/Classifier Fitting/Autogluon/Autogluon_Tabular_Only_SCF_Medium_Presets_Top3').fit(train_data=train_data, presets='medium_quality', excluded_model_types = ['KNN']) # exclude KNN as it's bad and takes up a ton of space
# Save space
