...
import pandas as pd
from compute_hsv_features import *
import shutil
import time
...
def main():
    ...
    with ProcessPoolExecutor(max_workers=num_cpus) as executor:
        ...
        feature_vectors = list(executor.map(compute_hsv_features, variant_df['Image Path']))
    # Enable printing
    enablePrint()
